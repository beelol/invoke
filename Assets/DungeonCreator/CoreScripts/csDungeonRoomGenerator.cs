...
public class csDungeonRoomGenerator
{
    #region Fields
        ...
        private int numRoomsToPlace = 10;
    ...
    #region Constructors	       
        ...
        public void Constructor
			(int numRoomsToPlace, 
	 		 ...
	 		 int maxRoomHeight)
        {
            this.numRoomsToPlace = numRoomsToPlace;
    ...
    #region Properties
        ...
        {
            get { return numRoomsToPlace; }
            set { numRoomsToPlace = value; }
        }
    ...
    #region Methods
        ...
        { 
            ...
            for (int roomCounter = 0; roomCounter < numRoomsToPlace; roomCounter++)
            {
				...
				{
					if (roomCounter < numRoomsToPlace / 2)
					{
